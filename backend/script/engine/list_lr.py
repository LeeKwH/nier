...
list_lr_feature = ['Conv1d', 'Conv2d', 'Conv3d', 'ConvTranspose1d', 'ConvTranspose2d', 'ConvTranspose3d', #conv
               ...
               'BatchNorm1d', 'BatchNorm2d', 'BatchNorm3d', 'GroupNorm', 'SyncBatchNorm', 'LayerNorm','InstanceNorm1d','InstanceNorm2d', 'InstanceNorm3d', #norm
               'RNN', 'LSTM', 'GRU', #rnn
               'Linear' #linear
               ]
# ============================================================================= #
...
list_lr_2d = ['Conv1d', 'ConvTranspose1d', 'BatchNorm1d', 'InstanceNorm1d','MaxPool1d','MaxUnPool1d', 'AvgPool1d', 'RNN', 'LSTM',  #3D
...
list_lr_order = ['RNN', 'LSTM', 'GRU'] #(N,L,H)
list_lr_order_trans = [x for x in list_lr_2d if x not in ['RNN', 'LSTM', 'GRU']]  #(N,L,H)
# ============================================================================= #
